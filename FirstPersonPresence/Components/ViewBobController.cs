...
public class ViewBobController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        Vector3 dynamicHoldPosition = new Vector3(0f, -_cameraController.GetDegreesY() * 0.02222f * Main.Instance.toolHeightYSensitivity, -(Mathf.Cos(Mathf.PI * _cameraController.GetDegreesY() * 0.01111f) - 1) * 0.5f * Main.Instance.toolHeightZSensitivity) * 0.05f;

        _toolBobRoot.transform.localPosition = new Vector3(toolBobX, toolBobY, 0f) + dynamicHoldPosition;
